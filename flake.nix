{
  ...
  outputs = inputs:
    inputs.flake-parts.lib.mkFlake
      ...
      {
        imports = [
          ./zomes/integrity/comments/zome.nix
          ./zomes/coordinator/comments/zome.nix
            ...
            packages.scaffold = pkgs.symlinkJoin {
              ...
              postBuild = ''
                wrapProgram $out/bin/scaffold-remote-zome \
                  --add-flags "comments-zome \
                    --integrity-zome-name comments_integrity \
                    --coordinator-zome-name comments \
                    --remote-zome-git-url github:darksoil-studio/comments-zome \
                    --remote-npm-package-name @darksoil-studio/comments-zome \
                    --remote-zome-git-branch main-0.5 \
                    --context-element comments-context \
                    --context-element-import @darksoil-studio/comments-zome/dist/elements/comments-context.js" 
              '';
            };
          };
      };
