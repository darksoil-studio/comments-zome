    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::CommentToComments => {
                validate_create_link_comment_to_comments(action, base_address, target_address, tag)
            }
        ...
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::CommentToComments => validate_delete_link_comment_to_comments(
                action,
                original_action,
                base_address,
                target_address,
        ...
        FlatOp::StoreRecord(store_record) => {
            match store_record {
                ...
                OpRecord::CreateLink {
                    ...
                    LinkTypes::CommentToComments => validate_create_link_comment_to_comments(
                        action,
                        base_address,
                        target_address,
                        tag,
                    ),
                    LinkTypes::CommentUpdates => validate_create_link_comment_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
